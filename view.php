...
<head>
  ...
  <title>Rumah Sakit XXX | DataTables</title>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                          ...
                          ?>
                  <tr>
                    <td><?php echo $data['id_no_rm']; ?></td>
                    <td><?php echo $data['id_nm_pasien']; ?></td>
                    <td><?php echo $data['id_tgl_masuk']; ?></td>
                    <td><?php echo $data['id_jam_masuk']; ?></td>
                    <td><?php echo $data['id_tl_pasien']; ?></td>
                    <td><?php echo $data['id_ta_pasien']; ?></td>
                    <td><?php echo $data['id_sex']; ?></td>
                    <td><?php echo $data['id_alamat']; ?></td>
                    <td><?php echo $data['id_umur_pasien']; ?></td>
                    <td><?php echo $data['id_no_tlp']; ?></td>
                  </tr>
                  <?php } ?>
                  <!-- <tr>
                    <td>Trident</td>
